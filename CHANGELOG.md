...
- **Синхронізація функціоналу з гілкою main**: Усі покращення (динамічна дата оновлення у футері, почесне місце власника чату, стійкий пошук власника та імпорт повідомлень від імені каналів) тепер перенесені у класичну (Bare-Metal) версію.
